To run the client you will need the following jar files in your classpath and they can be found in the directory /opt/info/courses/COMP20032/EX2/libraries (you don't need to make a copy of these files).
...
uk.ac.manchester.cs.comp20032.lab2.ClientReserve

To invoke ClientRecMsg from the command line:

java -classpath $CLASSPATH -Djavax.xml.parsers.DocumentBuilderFactory=org.apache.xerces.jaxp.DocumentBuilderFactoryImpl \
-Djavax.xml.transform.TransformerFactory=org.apache.xalan.xsltc.trax.TransformerFactoryImpl \
uk.ac.manchester.cs.comp20032.lab2.ClientRecMsg http://rpc210.cs.man.ac.uk:3010/queue/msg/24?username=your_username&password=your_password
